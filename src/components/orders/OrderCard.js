...
import { Clock, MapPin, Package, ChevronRight, AlertTriangle } from "lucide-react";
...
export default function OrderCard({ order }) {
  ...
  const canDispute = ["delivered", "cancelled"].includes(order.status);
  
  const handleDispute = (disputeData) => {
